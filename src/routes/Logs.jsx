      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex">
          <div className="mr-6 relative bg-[#f0f2f5] rounded-lg">
            <input type="text" placeholder="Search..." className=" pl-10 pr-2 outline-none w-full h-full" />
            <Icon path={mdiMagnify} size={1} className="absolute left-3 top-1/2 transform -translate-y-1/2" />
          </div>
          <NavButton
            text="New log"
